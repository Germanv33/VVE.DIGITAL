...
const Worker_Registration = () => {
  ...
  const register = (password: string, username: string, fullname: string) => {
    axios
      .post("http://localhost:8081/api/v1/worker/register", {
        email: username,
        password: password,
        fullname: fullname,
      })
      ...
      {(props) => {
        ...
        return (
          <form action="submit" onSubmit={handleSubmit} method="post">
            <h1>Create your worker account</h1>
            <h2>Account to manage costumer's projects</h2>
...
export default observer(Worker_Registration);
