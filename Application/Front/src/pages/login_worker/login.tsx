...
const Worker_Login = () => {
  ...
  const signin = (password: string, username: string) => {
    axios
      .post(
        "http://localhost:8081/api/v1/worker/login",
        ...
        return (
          <form id="form" onSubmit={handleSubmit} action="submit" method="post">
            ...
            <span className="toregister">
              Don't have an work account ?
              <NavLink to="/worker/signup">
                <a> Sign up</a>
              </NavLink>
            </span>
          </form>
...
export default observer(Worker_Login);
